...
*Mục tiêu: Thiết lập lớp proxy để Agent có thể giao tiếp với LLM thông qua MetaClaw.*
...
- [ ] **Local Setup**:
    - Cài đặt MetaClaw: `pip install "metaclaw[evolve]"`
    - Khởi tạo: `metaclaw setup`
    - Chạy proxy: `metaclaw start --mode skills_only --port 30000`

### Phase 2: Skill Sync Bridge
*Mục tiêu: Tự động hóa việc đưa các skill sinh ra từ `mcp-gen` vào MetaClaw.*
...
*Mục tiêu: Kích hoạt khả năng ghi nhớ dài hạn và học từ phản hồi người dùng.*
...
*Kiến trúc hiện tại đang triển khai.*
...
*Kiến trúc hướng tới trong tương lai.*
