    ...
    <main className="flex-1 overflow-y-auto px-8 pb-12 pt-4 scroll-smooth">
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center z-10 py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-20">
          <a href="/chat" className="px-10 py-5 bg-gradient-to-r from-primary to-primary-container text-on-primary-container rounded-full font-bold text-lg shadow-[0_10px_30px_rgba(178,153,255,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center">
            Start Chatting Now
          </a>
